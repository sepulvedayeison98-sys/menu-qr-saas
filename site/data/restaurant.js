  ...
  categorias: [
    {
      ...
      items: [
        ...
        { nombre: "Capuchino", precio: 6000, aperitivo: true, desc: "Espresso coronado con espuma de leche sedosa." },
        ...
        { nombre: "Café con Leche (perico)", precio: 2800, desc: "El equilibrio clásico de café y leche caliente." },
      ],
    },
    {
      nombre: "Fríos",
      items: [
        ...
        { nombre: "Café Milenio", precio: 8500, aperitivo: true, desc: "Café helado con chantillí." },
        { nombre: "Milo Frío", precios: [{ tam: "14 oz", precio: 6500 }, { tam: "9 oz", precio: 4000 }], desc: "Chocolate malteado helado y cremoso." },
        { nombre: "Ice Coffee", precio: 3000, desc: "Café frío servido sobre hielo." },
      ],
    },
    {
      nombre: "Snacks",
